...
1. Explorar el ecosistema completo en [docs/ECOSYSTEM_CONTEXT.md](docs/ECOSYSTEM_CONTEXT.md)
2. Leer el manual de usuario en [docs/USER_GUIDE.md](docs/USER_GUIDE.md)
3. Revisar la hoja de ruta de Hermes y Nexus en [docs/HERMES_NEXUS_ROADMAP.md](docs/HERMES_NEXUS_ROADMAP.md)
4. Configurar trazabilidad de costos en [docs/COST_TRACKER.md](docs/COST_TRACKER.md)
